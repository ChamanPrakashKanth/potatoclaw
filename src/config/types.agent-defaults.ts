...
export type AgentDefaultsConfig = {
  ...
  experimental?: {
    ...
    /**
     * Aggressive ultra-low-resource optimization for small local models (3B-4B)
     * and low-memory hardware (4GB VRAM, 8GB RAM). Enables compact prompts,
     * dynamic tool routing, bounded observations, and context down to 1024-2048.
     */
    potatoMode?: boolean;
  };
  /**
